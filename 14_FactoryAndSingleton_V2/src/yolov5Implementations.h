...
// 使用宏注册算法
REGISTER_ALGO(Algo_Type::Libtorch, YOLOv5_Libtorch);
REGISTER_ALGO(Algo_Type::ONNXRuntime, YOLOv5_ONNXRuntime);
REGISTER_ALGO(Algo_Type::OpenCV, YOLOv5_OpenCV);
REGISTER_ALGO(Algo_Type::OpenVINO, YOLOv5_OpenVINO);
REGISTER_ALGO(Algo_Type::TensorRT, YOLOv5_TensorRT);
